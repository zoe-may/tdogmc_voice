...
public class PacketHandler {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            // --- FIX: Use modern ResourceLocation constructor ---
            ResourceLocation.fromNamespaceAndPath(Tdogmc_voice.MODID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        ...
        INSTANCE.messageBuilder(RequestDataC2SPacket.class, id(), NetworkDirection.PLAY_TO_SERVER)
